  ...
  return (
    <div className="card group overflow-hidden">
      ...
      <div className="p-5">
        ...
        <p className="mt-2 text-sm leading-relaxed line-clamp-2" style={{ color: "var(--muted-fg)" }}>
          {project.description}
        </p>
        ...
        <div className="mt-5 flex items-center gap-4 pt-4" style={{ borderTop: "1px solid var(--bdr)" }}>
          {project.githubLink && (
            <a
