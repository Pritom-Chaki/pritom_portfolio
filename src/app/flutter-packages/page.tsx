...
export default function FlutterPackagesPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="mt-10 grid gap-6 animate-fade-in-delay-1">
        {flutterPackages.map((pkg) => (
          <div key={pkg.name} className="card group p-6">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex gap-4 flex-1">
                <img
                  src="/logo/package_logo.png"
                  alt="pub.dev"
                  width={40}
                  height={40}
                  className="shrink-0 mt-0.5 object-contain aspect-square"
                />
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h3 className="font-semibold font-mono text-base">
                      {pkg.name}
                    </h3>
